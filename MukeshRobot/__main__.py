...
def Mukesh_about_callback(update: Update, context: CallbackContext):
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="pantekyks_support"
                        ),
                        InlineKeyboardButton(
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="sᴏᴜʀᴄᴇ",
                            url="https://github.com/Hamam22/KIYUBIxROBOT",
                        ),
                    ],
                    [
    ...
    elif query.data == "pantekyks_support":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/gabutanbabyoo"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ", url="https://github.com/Hamam22"
                        ),
                    ],
                    [
