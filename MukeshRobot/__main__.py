...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEX = """
ʜᴇʟʟᴏ `{}`, ɪ'ᴍ sᴛᴀʀʟɪɢʜᴛ ᴍᴜsɪᴄ \nsᴛᴀʀᴛɪɴɢ . . . 
"""


PM_START_TEXT = """ 
*ʜᴇʏ* {} , ❣️
*๏ ʜᴀʟʟᴏ ꜱᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ {}
ꜱᴀʏᴀ ᴀᴅᴀʟᴀʜ {} ʙᴏᴛ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ & ᴍᴜꜱɪᴄ, ʏᴀɴɢ ᴄᴏᴄᴏᴋ ᴜɴᴛᴜᴋ 
ᴍᴇʟᴀᴋᴜᴋᴀɴ ꜱᴛʀᴇᴀᴍɪɴɢ ᴍᴜꜱɪᴄ/ᴠɪᴅᴇᴏ.ᴅɪ ᴏʙʀᴏʟᴀɴ ꜱᴜᴀʀᴀ ᴛᴇʟᴇɢʀᴀᴍ.*
❏──「sᴜᴘᴘᴏʀᴛ sᴛʀᴇᴀᴍɪɴɢ」────❏
├• ᴍᴜsɪᴄ
├• ᴠɪᴅᴇᴏ
├• ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋ    
├• sᴘᴏᴛɪғʏ ʟɪɴᴋ
├• ᴀᴅᴅ ꜱᴀʏᴀ ᴋᴇ ɢʀᴜᴘ ᴀɴᴅᴀ.
❏───「ɪɴғᴏ ʙᴏᴛs」─────────❏
├• ᴜꜱᴇʀꜱ: {}
├• ᴄʜᴀᴛꜱ: {}
❏─────────────────────❏
...
HELP_STRINGS = f"""
» *{BOT_NAME}  ᴋʟɪᴋ ᴛᴏᴍʙᴏʟ ᴅɪ ʙᴀᴡᴀʜ ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴀᴘᴀᴛᴋᴀɴ ᴘᴇɴᴊᴇʟᴀsᴀɴ ᴛᴇɴᴛᴀɴɢ ᴘᴇʀɪɴᴛᴀʜ ᴛᴇʀᴛᴇɴᴛᴜ*"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            START_IMG,
            caption="ɪ ᴀᴍ ᴀʟɪᴠᴇ ʙᴀʙʏ  !\n<b>ᴀᴋᴜ ᴛɪᴅᴀᴋ ᴛɪᴅᴜʀ ʜɪɴɢɢᴀ:</b> <code>{}</code>".format(
                uptime
            ),
...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        query.message.edit_caption("**๏ ᴋʟɪᴋ ᴛᴏᴍʙᴏʟ ᴅɪ ʙᴀᴡᴀʜ ɪɴɪ ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴀᴘᴀᴛᴋᴀɴ ʙᴀɴᴛᴜᴀɴ ᴅᴀɴ ɪɴғᴏʀᴍᴀsɪ ʟᴇʙɪʜ ʟᴀɴᴊᴜᴛ**"
            f"\n\nᴊɪᴋᴀ ᴋᴀᴍᴜ ᴍᴇɴᴇᴍᴜᴋᴀɴ ʙᴜɢ ᴅɪ dispatcher.bot.first_name} ᴀᴛᴀᴜ ᴊɪᴋᴀ ᴋᴀᴍᴜ ɪɴɢɪɴ ᴍᴇᴍʙᴇʀɪᴋᴀɴ ᴛᴀɴɢɢᴀᴘᴀɴ ᴛᴇɴᴛᴀɴɢ (dispatcher.bot.first_name}, sɪʟᴀʜᴋᴀɴ ʟᴀᴘᴏʀᴋᴀɴ ᴅɪ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
def MukeshRobot_Main_Callback(update: Update, context: CallbackContext):
 ...
 ᴅɪ sɪɴɪ ᴀᴅᴀʟᴀʜ ᴍᴇɴᴜ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ {BOT_NAME}
""",
            parse_mode=ParseMode.MARKDOWN,
...
ꜱᴇᴛ ᴀ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇꜱꜱᴀɢᴇ!""",parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_caption("""ʙᴀɴᴛᴜ ꜱᴜᴘᴘᴏʀᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴀɢᴀʀ ʙᴏᴛ ᴛᴇᴛᴀᴘ ᴀᴋᴛɪꜰ ᴅᴇɴɢᴀɴ ᴄᴀʀᴀ ᴅɪʙᴀᴡᴀʜ. 

ɴᴏᴛᴇ ! ᴀɢᴀʀ ʙᴏᴛ ꜱᴇʟᴀʟᴜ ᴀᴋᴛɪꜰ, ᴍᴀʀɪ ꜱᴜᴘᴘᴏʀᴛ ʙᴏᴛ ᴅᴇɴɢᴀɴ ᴄᴀʀᴀ ᴅᴏɴᴀꜱɪ ᴀᴛᴀᴜ ʙᴀɴᴛᴜ ᴊᴏɪɴ ɢʀᴏᴜᴘ/ᴄʜᴀɴɴᴇʟꜱ, ᴊɪᴋᴀ ᴛɪᴅᴀᴋ ɪɴɢɪɴ ᴍᴇʟᴀᴋᴜᴋᴀɴ ᴋᴇᴅᴜᴀɴʏᴀ ᴛᴏʟᴏɴɢ ᴊᴀɢᴀ ʙᴏᴛ ᴅᴇɴɢᴀɴ ʙᴀɪᴋ ᴅᴇɴɢᴀɴ ᴄᴀʀᴀ ᴛɪᴅᴀᴋ ᴍᴇᴍᴜᴛᴀʀ ᴠɪᴅɪᴏ ʏᴀɴɢ ʙᴇʀʙᴀᴜ 18+.

ᴛᴇʀɪᴍᴀ ᴋᴀsɪʜ sᴜᴅᴀʜ sᴜᴘᴘᴏʀᴛ """,parse_mode=ParseMode.MARKDOWN,
