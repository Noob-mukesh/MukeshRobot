...
if ENV:
    ...
    STRICT_GBAN = bool(os.environ.get("speeds_net", True))
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "speeds_net")
    ...
    try:
        ...
        DEV_USERS = set(int(x) for x in os.environ.get("DEV_USERS", "6385717717").split())
    except ValueError:
